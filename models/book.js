...
class Book {
   ...
   *
   * */
//ab. looks like they are going to pass in a data object; so will it be something like { "data" : {"isbn" : ....}} or maybe normally we would do const { isbn, amazon_url...} = req.body.data????????  or maybe this is instead of entering into post route in insomnia the json that goes in the request.body
